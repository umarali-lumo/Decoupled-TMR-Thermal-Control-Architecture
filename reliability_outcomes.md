...
| Single-Channel Reliability \( R \) | Resulting \( R_{TMR} \) | Relative Improvement |
|------------------------------------|--------------------------|----------------------|
| 0.90                               | 0.972                    | +8.0 %               |
| 0.95                               | 0.993                    | +4.5 %               |
| 0.99                               | 0.9997                   | +0.9 %               |
...
- Single sensor MTTF = \( 1/\lambda \)
- Classical TMR MTTF = \( 5/(6\lambda) \)

Although absolute mean lifetime is reduced, mission reliability \( R(t) \) is superior for all mission durations shorter than the crossover point \( t = \ln(2)/\lambda \). This is the regime relevant to most safety-critical thermal-control missions.
...
| Risk Reduction Factor (RRF)     | ≈ 209×                         | Unannounced secondary failure probability  |
